...
let foodArray = ['chana masala', 'pizza', 'smoothies'];
...
console.log('First animal is', foodArray[0]);
...
console.log('Last food is', foodArray[foodArray.length -1]);
...
foodArray.push('gnocchi');
console.log('Added a food to end,', animalArray);
...
foodArray.splice( 1, 1, 'dumplings')
console.log('After replacing the second food, the foods are now', foodArray);

// 4.f (STRETCH) TODO: Sort your favoriteFoods array
//     in reverse alphabetical order. Log the array.
foodArray.reverse(foodArray.sort());
...
console.log('The new joined array is', newArray);